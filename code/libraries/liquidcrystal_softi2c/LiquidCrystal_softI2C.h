...
class LiquidCrystal_softI2C : public LCD
{
public:
    ...
    */
   LiquidCrystal_softI2C (uint8_t lcd_Addr);
   // Constructor with backlight control
   LiquidCrystal_softI2C (uint8_t lcd_Addr, uint8_t backlighPin, t_backlighPol pol);
    ...
    */
   LiquidCrystal_softI2C( uint8_t lcd_Addr, uint8_t En, uint8_t Rw, uint8_t Rs);
   // Constructor with backlight control
   LiquidCrystal_softI2C(uint8_t lcd_Addr, uint8_t En, uint8_t Rw, uint8_t Rs,
...
private:
   ...
   I2CIO_soft _i2cio;            // I2CIO PCF8574* expansion module driver I2CLCDextraIO
