...
// Extendable: Yes
//
// @file LiquidCrystal_softI2C.cpp
// This file implements a basic liquid crystal library that comes as standard
// in the Arduino SDK but using an I2C IO extension board with software I2C.
//
// @brief
...
// This rework is using a Software I2C library provided by Bernhard Nebel and
// available here: https://github.com/felias-fogg/SoftI2CMaster.
//
...
// CONSTRUCTORS
// ---------------------------------------------------------------------------
LiquidCrystal_softI2C::LiquidCrystal_softI2C( uint8_t lcd_Addr )
{
   config(lcd_Addr, EN, RW, RS, D4, D5, D6, D7);
}


LiquidCrystal_softI2C::LiquidCrystal_softI2C(uint8_t lcd_Addr, uint8_t backlighPin,
...
LiquidCrystal_softI2C::LiquidCrystal_softI2C(uint8_t lcd_Addr, uint8_t En, uint8_t Rw,
                                             uint8_t Rs)
{
   config(lcd_Addr, En, Rw, Rs, D4, D5, D6, D7);
}
...
//
// setBacklightPin
void LiquidCrystal_softI2C::setBacklightPin ( uint8_t value, t_backlighPol pol = POSITIVE )
{
...
//
// setBacklight
void LiquidCrystal_softI2C::setBacklight( uint8_t value )
{
...
//
// init
int LiquidCrystal_softI2C::init()
{
   int status = 0;
...
//
// config
void LiquidCrystal_softI2C::config (uint8_t lcd_Addr, uint8_t En, uint8_t Rw, uint8_t Rs,
...
//
// write4bits
void LiquidCrystal_softI2C::write4bits ( uint8_t value, uint8_t mode )
{
...
//
// pulseEnable
void LiquidCrystal_softI2C::pulseEnable (uint8_t data)
{
