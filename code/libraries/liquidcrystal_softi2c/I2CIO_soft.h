...
#ifndef _I2CIO_soft_H_
#define _I2CIO_soft_H_

#include <inttypes.h>

#define _I2CIO_SOFT_VERSION "1.0.0"

/*!
 @class
 @abstract    I2CIO_soft
 @discussion  Library driver to control PCF8574 based ASICs. Implementing
 library calls to set/get port through I2C bus through the Software I2C library
 provided by Bernhard Nebel and available here:
   https://github.com/felias-fogg/SoftI2CMaster
 */
